...
Endpoint：
  ...
  GET  /             — 回傳 static/index_v2.html（開發用）
"""
...
@app.route("/")
def index():
    """回傳前端頁面（優先 index_v2.html，fallback index.html）。"""
    v2 = _STATIC_DIR / "index_v2.html"
    filename = "index_v2.html" if v2.exists() else "index.html"
